...
unimportant=['px1','px2','py1','py2','pz1','pz2','phi1','phi2','w1','w2']
...
rfc = CatBoostClassifier(iterations=5,random_state = seed,eval_metric='F1')#CatBoostClassifier(**params_no_its,iterations=4,random_state=seed,)#
...
#TODO model gives 0.52710 with the slightest overfit, maybe use fixed less iterations?
